...
import { grey, blueGrey, blue, deepOrange } from "@material-ui/core/colors";
...
function Numbers(props) {
	const style = {
		...
		textAlign: "center",
		margin: "0.6rem",
		backgroundColor: props.num ? blue[800] : blueGrey[100],
	...
	const currentNum = { ...style, backgroundColor: deepOrange[500] };
